        ...
        <React.Fragment>
          ...
          <div className={css(App.appStyles.App)}>
            ...
            <div className={css(App.appStyles['App-body'])}>
              <BodySectionWithMarginBottom title={this.state.user.isLoggedIn? 'Course list' : 'Log in to continue'}>
                {this.state.user.isLoggedIn? <CourseList listCourses={listCourses}/> : <Login logIn={this.logIn} />}
