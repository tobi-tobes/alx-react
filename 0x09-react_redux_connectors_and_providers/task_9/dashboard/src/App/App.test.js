...
import {connectedNotificationsContainer as NotificationsContainer} from '../Notifications/NotificationsContainer';
...
describe('App', function () {
  ...
  it('renders NotificationsContainer component', function () {
    const wrapper = shallow(<App />);
    expect(wrapper.find(NotificationsContainer).length).toBe(1);
  });
