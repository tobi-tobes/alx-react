...
function CourseListRow(props) {
  ...
  const rowStyle = !props.isChecked ? {...styles.rowChecked, paddingTop: '2px', paddingBottom: '2px'} : {backgroundColor: '#f5f5f5ab', paddingTop: '2px', paddingBottom: '2px'};
  ...
  if (isHeader) {
    ...
    elementToRender = <tr style={rowStyle}><td><input type='checkbox' onChange={() => props.onChangeRow(props.id, !props.isChecked)}></input>{ textFirstCell }</td><td>{ textSecondCell }</td></tr>
  }
